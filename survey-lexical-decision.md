...
abstract: "This document outlines the evaluation interface for the Psycholinguistics Gym's lexical decision module and surveys the literature on predicting lexical decision reaction times (LD-RTs). It defines a taxonomy of predictor types, catalogs available megastudy datasets, and reviews the models and features that have been used to predict LD-RT data."
date: 2026-03-02
...
# Gym interfaces for LD-RT evaluation {#sec-gym-interfaces}
...
The rest of this document catalogs the human dependent variables these interfaces target (@sec-humandv), defines a taxonomy of predictor types (@sec-taxonomy), lists available datasets (@sec-datasets), reviews the literature organized by predictor type (@sec-literature), and synthesizes key findings (@sec-synthesis).
