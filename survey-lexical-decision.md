...
2. **British Lexicon Project (BLP).** @keuleers2012blp
    ...
    - 28,730 words + nonwords; 78 participants (repeated measures); British English; visual LD (lowercase); nonwords generated by Wuggy. Available at crr.ugent.be/blp.
...
5. **The Rank Hypothesis.** @murray2004rank
...
6. **Frequency and the Decision Stage.** @balota1984frequency
...
7. **Lexical Access and Naming Time.** @forster1973lexical
...
8. **Orthographic Neighborhood Size (N).** @coltheart1977access
...
9. **Neighborhood Effects Review.** @andrews1997neighborhood
...
10. **Word Length Effects.** @new2006wordlength
...
11. **Social Media Frequency.** @herdagdelen2017social
...
12. **Word Prevalence.** @keuleers2015prevalence
...
13. **Age of Acquisition Norms.** @kuperman2012aoa
...
14. **Emotion Effects.** @kuperman2014emotion
...
15. **Noise in Lexical Decision.** @diependaele2012noise
...
16. **Word Frequency in German.** @brysbaert2011german
...
17. **Word Frequency Effect Review.** @brysbaert2018review
...
5. **SWOW-EN Word Associations.** @dedeyne2019swow
...
6. **Semantic Distinctiveness.** @johns2022distinctiveness [see also @jones2012diversity]
...
7. **Traces of Meaning.** @sassenhagen2020traces
...
8. **Semantic Richness Effects.** @pexman2008richness
...
1. **Individual Differences.** @yap2012individual
...
2. **Cognitive Plausibility of Subword Tokenization.** @beinborn2023tokenization
...
4. **Simulating Lexical Decision Times with LLMs.** @brysbaert2025simulating
...
5. **LLM-Augmented Psycholinguistic Datasets.** @trott2024augment
...
2. **BEAGLE and Priming.** @jones2006beagle
...
3. **LSA Cosines Predict Priming.** @guenther2016lsa
...
4. **LM Surprisal Explains N400.** @michaelov2024n400
